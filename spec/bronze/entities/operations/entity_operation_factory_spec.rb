require 'bronze/entities/operations/entity_operation_factory'

require 'support/examples/entities/entity_operation_examples'

RSpec.describe Bronze::Entities::Operations::EntityOperationFactory do
  ...
  shared_examples 'should define a contract operation' do |command_name|
    ...
    describe "::#{const_name}" do
      let(:operation_class) do
        Bronze::Entities::Operations.const_get("#{const_name}Operation")
      end
