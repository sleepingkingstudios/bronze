...
RSpec.describe Bronze::Constraints::ConstraintBuilder do
  shared_examples 'should build a constraint' do |constraint_class, proc = nil|
  ...
  describe '#build_constraint' do
    it { expect(instance).to respond_to(:build_constraint).with(2).arguments }
  ...
  describe '#build_empty_constraint' do
    ...
    it 'should define the method' do
      expect(instance).to respond_to(:build_empty_constraint).with(1).argument
    end # it
  ...
  describe '#build_equal_constraint' do
    ...
    it 'should define the method' do
      expect(instance).to respond_to(:build_equal_constraint).with(1).argument
    end # it
  ...
  describe '#build_nil_constraint' do
    ...
    it 'should define the method' do
      expect(instance).to respond_to(:build_nil_constraint).with(1).argument
    end # it
  ...
  describe '#build_type_constraint' do
    ...
    it 'should define the method' do
      expect(instance).to respond_to(:build_type_constraint).with(1).argument
    end # it
